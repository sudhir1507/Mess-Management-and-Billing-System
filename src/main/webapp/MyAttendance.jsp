...
<%@page import="org.messmanagement.admin.repository.AttenedanceRepositoryImpl"%>
...
<%@include file="userdashboard.jsp"%>
	<div class="col-md-8 offset-md-1 mt-5">
		<br> <br>
		<center><h2 id="catcaption">My Attendance Information</h2></center>
...
<!-- 					<th>Candidate Name</th> -->
			...
			<tbody>
                ...
                int reid=Integer.parseInt(session.getAttribute("rid").toString());
				AttenedanceService aService=new AttenedanceServiceImpl();
				List<Object[]> list=aService.getMyAttendance(reid);
				if(list!=null){
				int count=0;
				for (Object obj[]:list) {
				%>
...
<%--       				<td data-label="name"><%=obj[0] %></td> --%>
     				 <td data-label="date"><%=obj[0] %></td>
     				 <td data-label="mealtime"><%=obj[1] %></td>
				...
				<%
					...
					%>
					<tr>
					   <td colspan="3"><h3>Attendance Not Yet Tracked</h3></td>
					</tr>
					<%
				}
				%>
