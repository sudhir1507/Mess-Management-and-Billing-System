...
<body>
    ...
    <%
                    ...
                    String contact=rmodel.getContact();
                    String address=rmodel.getAddress();
                    
                    String Email=rmodel.getUsername();
                    String password=rmodel.getPassword();
                    %>
 
        <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 wrapper"  id="dashboard">
            <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                <a href="updateprofile?rid=<%=regid %>&name=<%=name%>&contact=<%=contact%>&address=<%=address %>&email=<%=Email %>&password=<%=password %>" class="d-flex align-items-center pb-3 mb-md-0 me-md-auto text-white text-decoration-none">
                ...
                <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                   <li>
                        <a href="#submenu1" data-bs-toggle="collapse" class="nav-link px-0 align-middle">
                            <i class="fs-4 bi-bootstrap"></i> <span class="ms-1 d-none d-sm-inline">Menu Details</span></a>
                        <ul class="collapse nav flex-column ms-1" id="submenu1" data-bs-parent="#menu">
                            <li class="w-100">
                                <a href="viewMenu.jsp" class="nav-link px-0"> <span class="d-none d-sm-inline innerspan">View Menu</span></a>
                            </li>
<!--                             <li> -->
...
<!--                             </li> -->
                    ...
                    <li>
                        <a href="#submenu2" data-bs-toggle="collapse" class="nav-link px-0 align-middle">
                            <i class="fs-4 bi-bootstrap"></i> <span class="ms-1 d-none d-sm-inline">Attendance details</span></a>
                        <ul class="collapse nav flex-column ms-1" id="submenu2" data-bs-parent="#menu">
                            <li class="w-100">
                                <a href="MyAttendance.jsp" class="nav-link px-0"> <span class="d-none d-sm-inline innerspan">View Attendance</span></a>
                            </li>
<!--                             <li> -->
